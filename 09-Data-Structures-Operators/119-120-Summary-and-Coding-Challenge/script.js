...
a map with a log of the events that happened during the game. The 
values are the events themselves, and the keys are the minutes in 
...
whether it's in the first half or second half (after 45 min) of 
the game, like this:
